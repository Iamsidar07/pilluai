...
export default function SignInPage() {
  return (
    <div className="grid w-full grow items-center px-4 sm:justify-center pt-12 lg:pt-24">
      <SignIn.Root>
        <Clerk.Loading>
          {(isGlobalLoading) => (
            <>
              <SignIn.Step name="start">
                <Card className="w-full sm:w-96 bg-gradient-to-br from-pink-50/25">
                  <Image
                    src="/logo.png"
                    alt="Pillu AI logo"
                    width={100}
                  ...
                  />
                  <CardHeader>
                    <CardTitle>Sign in to Pillu AI</CardTitle>
                    <CardDescription>
