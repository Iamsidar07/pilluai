...
const AuthForm = ({
  ...
  return (
    <div className="grainy-light min-h-screen">
      <div className="flex flex-col items-center w-full max-w-lg mx-auto p-4 lg:p-8 pt-12 lg:pt-24 z-[2]">
        <Image src="/logo.png" alt="logo" width={100} height={100} />
        <h1 className="text-3xl font-bold text-center mt-4">{title}</h1>
        <div className="w-full max-w-xl bg-white/55 border px-6 py-12 rounded-md mt-4 flex flex-col gap-4">
          <form
            action={handleSubmit}
